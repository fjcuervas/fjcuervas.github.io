(function ($) {
    ...
    jQuery(document).on('ready', function () {
        ...
        function initPortfolio() {
            ...
            /* fjcuervas. Pruebo a esconder solo el id #b   var afterFirst = '#b,#c';*/
			var afterFirst = '#b';
        ...
        function initMapsNormal() {
            ...
            var mapOptions = {
                ...
                /*fjcuervas. Cambio las coordenadas de google map*/
                //center: new google.maps.LatLng(51.5287352, -0.3817831),
				center: new google.maps.LatLng(37.3518171, -6.03828),
            ...
            $('form#contact-form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    .done(function () {
                        ...
                        Materialize.toast('Mensaje enviado correctamente. Le responderé lo antes posible. Gracias.', 4000);
                    ...
                    .fail(function () {
                        ...
                        Materialize.toast('Lo siento, ha ocurrido un error. Inténtelo de nuevo.', 4000);
    ...
    jQuery(window).on('load', function () {
		...
		/*fjcuervas. Comento las siguientes líneas para evitar el efecto fadein de las CARDS de las 2 primeras */
